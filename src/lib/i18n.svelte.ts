...
const EN: Dict = {
  ...
  "settings.androidSystemLockdown": "System VPN lockdown",
  "settings.androidSystemLockdownSub": "Optional extra, set in Android VPN settings: Always-on VPN + Block connections without VPN. It also applies when Varmlen is closed.",
  ...
  "core.androidManaged": "Bundled with the APK. Android blocks apps from running downloaded binaries (OS W^X restriction), so Xray updates with Varmlen.",
  "core.use": "Use",
...
const RU: Dict = {
  ...
  "settings.androidSystemLockdown": "Системный VPN lockdown",
  "settings.androidSystemLockdownSub": "Дополнительно, в настройках VPN Android: «Постоянная VPN» + «Блокировать соединения без VPN». Действует, даже когда Varmlen закрыт.",
  ...
  "core.androidManaged": "Встроена в APK. Android не даёт приложению запускать скачанные бинарники (системное ограничение W^X), поэтому Xray обновляется вместе с Varmlen.",
  "core.use": "Выбрать",
