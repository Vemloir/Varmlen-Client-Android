...
const EN: Dict = {
  ...
  "settings.androidKillswitchSub": "Open Android VPN settings, then enable Always-on VPN and Block connections without VPN. Android does not allow apps to toggle these protections directly.",
  ...
  "core.androidManaged": "Bundled with the APK; update Varmlen to update Xray.",
  "core.use": "Use",
...
const RU: Dict = {
  ...
  "settings.androidKillswitchSub": "Откройте системные настройки VPN и включите постоянную VPN и блокировку соединений без VPN. Android не разрешает приложению включать их напрямую.",
